...
try:
    from PyQt6.QtWidgets import (
        ...
        QLabel, QTextEdit, QSplitter, QGroupBox, QCheckBox,
...
class MainWindow(QMainWindow):
    ...
    def add_resource(self):
        ...
        QMessageBox.information(self, "Добавить ресурс", "Мастер добавления ресурсов будет реализован в следующей версии")
